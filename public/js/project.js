...
var Base = /*#__PURE__*/function () {
  function Base(baseDOM) {
    ...
    this.baseDOM._document.ready(function (e) {
      _this.initDOMElements(e);

      _this.onDOMReady(e);
    });

    this.baseDOM._window.on('load', function (e) {
      return _this.onLoaded(e);
    });

    this.baseDOM._window.on('resize', function (e) {
      return _this.onResized(e);
    });

    this.baseDOM._window.on('wheel', function (e) {
      return _this.onWheel(e);
    });

    this.baseDOM._window.on('onorientationchange', function (e) {
...
var Project = /*#__PURE__*/function (_Base) {
  ...
  _createClass(Project, [{
    ...
    key: "onDOMReady",
    value: function onDOMReady(e) {// $('[data-fancybox="gallery"]').fancybox({});
      // this.els._galleryItem.fancybox();
    }
  }]);

  return Project;
}(_Base_js__WEBPACK_IMPORTED_MODULE_0__["default"]); // require('@fancyapps/fancybox/dist/jquery.fancybox.min');
// var $ = require('jquery');
...
var ThemeSwitcher = /*#__PURE__*/function (_Base) {
  _inherits(ThemeSwitcher, _Base);
  ...
  _createClass(ThemeSwitcher, [{
    ...
    value: function onDOMReady(e) {
      ...
      this.els._themeSwitcherSlider.click(function (e) {
        return _this.toggleThemeSwitcher(e);
      });
    }
  }, {
    key: "toggleThemeSwitcher",
    value: function toggleThemeSwitcher(e) {
...
/* harmony import */ var _components_Project__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/Project */ "./resources/js/components/Project.js");
window.$ = window.jQuery = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js"); // import $ from 'jquery'; window.jQuery = $; window.$ = $;
...
new _Base_js__WEBPACK_IMPORTED_MODULE_0__["default"]().call(function () {
  ...
  new _components_Project__WEBPACK_IMPORTED_MODULE_3__["default"]();
});
...
/***/ 1:
/*!*********************************************!*\
  !*** multi ./resources/js/pages/project.js ***!
  \*********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /home/kate/projects/portfolio/resources/js/pages/project.js */"./resources/js/pages/project.js");
